...
func (c *FakeActions) Get(ctx context.Context, name string, options v1.GetOptions) (result *corev1.Action, err error) {
	obj, err := c.Fake.
...
func (c *FakeActions) List(ctx context.Context, opts v1.ListOptions) (result *corev1.ActionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeActions) Create(ctx context.Context, action *corev1.Action, opts v1.CreateOptions) (result *corev1.Action, err error) {
	obj, err := c.Fake.
...
func (c *FakeActions) Update(ctx context.Context, action *corev1.Action, opts v1.UpdateOptions) (result *corev1.Action, err error) {
	obj, err := c.Fake.
...
func (c *FakeActions) UpdateStatus(ctx context.Context, action *corev1.Action, opts v1.UpdateOptions) (*corev1.Action, error) {
	obj, err := c.Fake.
...
func (c *FakeActions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *corev1.Action, err error) {
	obj, err := c.Fake.
...
func (c *FakeActions) Apply(ctx context.Context, action *applyconfigurationscorev1.ActionApplyConfiguration, opts v1.ApplyOptions) (result *corev1.Action, err error) {
	if action == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(actionsResource, c.ns, *name, types.ApplyPatchType, data), &corev1.Action{})
...
func (c *FakeActions) ApplyStatus(ctx context.Context, action *applyconfigurationscorev1.ActionApplyConfiguration, opts v1.ApplyOptions) (result *corev1.Action, err error) {
	if action == nil {
		return nil, fmt.Errorf("action provided to Apply must not be nil")
	}
	data, err := json.Marshal(action)
	...
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(actionsResource, c.ns, *name, types.ApplyPatchType, data, "status"), &corev1.Action{})
