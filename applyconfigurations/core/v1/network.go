...
func (b *NetworkApplyConfiguration) WithNetID(value string) *NetworkApplyConfiguration {
	b.NetID = &value
	return b
}
...
func (b *NetworkApplyConfiguration) WithPortID(value string) *NetworkApplyConfiguration {
	b.PortID = &value
	return b
}
