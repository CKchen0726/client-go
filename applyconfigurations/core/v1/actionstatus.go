...
// WithActionResult sets the ActionResult field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the ActionResult field is set to the value of the last call.
func (b *ActionStatusApplyConfiguration) WithActionResult(value string) *ActionStatusApplyConfiguration {
	b.ActionResult = &value
	return b
}
